...
Contexto: Una vitrina virtual tiene varios precios. El cliente ingresa cuánta
 plata tiene en el bolsillo, y el sistema le muestra solo los precios que le alcanza para pagar.
...
Limpia el input.
 */
let vitrina = [2500, 15000, 30000, 5000];
let opciones = [];
...
Contexto: Vamos agregando productos al carrito. 
Una función anota el producto y le pide ayuda a otra función para que dibuje el carrito actualizado en la pantalla.
Crea un arreglo vacío: let carrito = [];
Función Ayudante (La Pantalla): Crea actualizarPantalla(). 
Esta función tomará el arreglo carrito, lo unirá en un texto (ej: carrito.join(" - ")) y 
lo inyectará en el textContent del párrafo.
...
¡Limpia el input!
Al final de esta función, llama a actualizarPantalla() para que la vista se refresque 
automáticamente con el nuevo producto.
 */